        ...
        <div className="text-center max-w-3xl mx-auto space-y-6 flex flex-col items-center">
          ...
          <h2 className="font-display font-bold text-4xl sm:text-5xl lg:text-6xl tracking-tighter leading-[1.05] text-white">
            {isTurtle ? (
              ...
              <>
                Unlock the <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-400">Mysteries</span> of the Universe
              </>
            )}
          </h2>
          ...
          <p className="text-xs sm:text-sm max-w-2xl mx-auto leading-relaxed text-zinc-400 font-sans">
            {isTurtle
              ? 'Founded by local parents, we make advanced chemistry, astronomy, and robotics collaborative and accessible for inquisitive minds. Where friendships and lifelong discoveries are born!'
              : 'Empowering children with rigorous experimental design and high-level technical frameworks. We train future researchers through disciplined science and meticulous analytical standards.'}
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-3 pt-4">
            {userProfile.level === 0 ? (
              <button
                ...
                onClick={onOpenJoin}
                className={`w-full sm:w-auto px-6 py-2.5 rounded-full font-bold text-xs uppercase tracking-widest transition-all duration-300 hover:scale-[1.02] active:scale-95 cursor-pointer flex items-center justify-center gap-2 shadow-lg ${isTurtle
                  ? 'bg-emerald-500 text-stone-950 hover:bg-emerald-400 hover:shadow-emerald-500/10'
                  : 'bg-blue-500 text-stone-950 hover:bg-blue-400 hover:shadow-blue-500/10'
                  }`}
              >
